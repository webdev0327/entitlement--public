 ...
 * @property {Grant=} grant - Only present if the operation was authorized.
 * @property {Usage=} usage - If the operation type requires counting, this object will be present (even if authorization is rejected).
 */
